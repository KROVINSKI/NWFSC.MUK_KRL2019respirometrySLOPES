...
T4dTotal <- T4dTotal %>% filter(Treatment %in% c("CUR", "CHG", "TMP", "n/a"))
dim(T4dTotal)
# [1] 349  76
...
df.lm.KrillR11 <- fortify(lm_KrillR11) 
...
## 12.x) Kate Tries to Write a "FOR" loop
Index variable "pony" 
```{r 12.2) Kate Tries to Write a "FOR" loop}

# # variable in vector "pony"
# for {(pony in T1dTotal)
#   #commands
# }
...
dfTrial01_KrilLR11 <- dtotal[dtotal$KrillID == "Trial01_KrilLR11",]
