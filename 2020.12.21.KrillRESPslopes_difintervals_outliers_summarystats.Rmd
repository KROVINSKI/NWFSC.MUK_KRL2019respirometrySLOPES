...
# 20.1a) Analysis, Respirometry - Creating Slope Functions & Linear Models  70% cutoff
```{r 20.1a) Analysis, Respirometry - Creating Slope Functions & Linear Models  70% cutoff  }
#*********************************
## 20.1a) Using the 70% dataframe
#*********************************
# #get slopes and r^2 values from dtotal 
...
# 20.1a) Analysis, Respirometry - Creating Slope Functions & Linear Models  1hr cutoff
```{r 20.1a) Analysis, Respirometry - Creating Slope Functions & Linear Models  1hr cutoff  }
#*********************************
## 20.1a) Using the 1hr cuttoff dataframe
#*********************************
# #get slopes and r^2 values from dtotal 
...
# 22. Summary Statisitics on the Unfiltered Dataframe dSlopes
```{r 22. Summary Statisitics on the Unfiltered Dataframe dSlopes}
...
write.csv(dSlopes.summary, "2020.12.16a_dSlopes_summary.csv")
```


## 22.1a Summary Statistics Graphed with Standard dSlope Values  
```{r 22.1a Summary Statistics Graphed with Standard dSlope Values, warning=FALSE}
...
# 2x.) Analysis, Respirometry - Correcting the Slope for Blanks - 80% cutoff
```{r 2x.) Analysis, Respirometry - Correcting the Slope for Blanks  - 80% cutoff}
...
ksSlopes80 <- ksSlopes80 %>% mutate(CorrSlope=case_when(
...
write.csv(ksSlopes80.summary, "2020.12.20_ksSlopes80_summary.csv")
```
...
Each treatment will have 1-4 mean values since a mean value was taken for each Trial
The purple dots represent the means
