...
krillslopes80 <- merge(ks80total, ksSlopes80, by="KrillID")

# krillslopes80$SensorName <- ""

krillslopes80 <- krillslopes80 %>% group_by(KrillID)
...
kdSlopes80$KrillID <- as.character(kdSlopes80$KrillID)
kdSlopes80$SensorName <- dRESPanimal$SensorName
kdSlopes80$TrialID <- dRESPanimal$TrialID
kdSlopes80$MOATS <- dRESPanimal$MOATS
kdSlopes80$Treatment<- dRESPanimal$Treatment
kdSlopes80$LoadingLocation<- dRESPanimal$LoadingLocation
kdSlopes80$VialNum<- dRESPanimal$GlassVialNumber
kdSlopes80$TelsonLength<- dRESPanimal$TelsonLength..mm.
kdSlopes80$WetWeight<- dRESPanimal$Size
...
[insert narrative section here]
detailing the differences about 80, 70, 1hr and all datapoints with outliers removed
