...
orip1 <- ggplot(T1dTotal, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
...
orip2 <- ggplot(T2dTotal, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
...
orip3 <- ggplot(T3dTotal, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
...
orip4 <- ggplot(T4dTotal, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
...
filtp1 <- ggplot(T1dTotal.filtered, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
  ggtitle("Trial01 Vial Oxygen over Time, Original with Outliers") +
...
filtp2 <- ggplot(T2dTotal.filtered, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
  ggtitle("Trial02 Vial Oxygen over Time, Original with Outliers") +
...
filtp3 <- ggplot(T3dTotal.filtered, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
  ggtitle("Trial03 Vial Oxygen over Time, Original with Outliers") +
...
filtp4 <- ggplot(T4dTotal.filtered, aes(x = Time, y = oxygen, colour = Treatment)) +
  geom_point(size = 1) +
  geom_smooth(method = "lm") +
  #scale_y_continuous(breaks=seq(250,950,by=50))   +
  ggtitle("Trial04 Vial Oxygen over Time, Original with Outliers") +
