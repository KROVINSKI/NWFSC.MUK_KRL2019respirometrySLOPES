...
[_] Remove Blanks from all treatments 
[_] transform the units for more "regular"- not extremely small numbers
...
T4.80.start
T4.80.stop <- tail(T4krillslopes80$Time,1)
T4.80.stop
...
T4.70.start <- head(T4krillslopes$Time,1)
T4.70.stop <- tail(T4krillslopes70$Time,1)
T4.70_duration <- as.numeric(T4.70.stop - T2.70.start, units = "mins")
T4.70_duration
...
T1.80.start 
## Trying to select just the first observation
#T1.80.start <- head(T1.80.start$Time, 1)

# T1.80.start <- DF[order(DF$et, descending=TRUE),];

# Trial1 2019-10-28 14:25:01 UTC

T1.80.stop
# Trial2 2019-10-28 16:35:20 UTC
