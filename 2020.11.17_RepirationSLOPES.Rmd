...
##  # the above loop negates creating a matrix correct?
...
```{r dealing with blanks}

#*********************************
## 5.) Analysis, Respirometry - Correcting the Slope for Blanks 
#*********************************

#blank corrected slope and blank-size corrected slope
#see blankslopecorrection.R for more comments and detail (this was 2014~2016 code Paul may have)
# x is equal to the blank vials  
x <- subset(dtotal, dtotal$MOATS == "blank")
row.names(x) <- NULL
#View(x)
x$slope
blankmeanslope <- x$slope 



## # what function am I trying to apply? 
## what is the ragged array and what is the function? 
