...
write.csv(dRESPmsr, file = "2020.11.30_respirometrymeasurements.csv", row.names = FALSE)
#|- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - |
...
write.table(UniqueKrillIDs, file = "2020.11.30dtotal_UniqueKrillIDs.csv")
#kable(UniqueSensorNames)
...
write.csv(dtotal, file = "2020.11.17_dtotal.csv", row.names = FALSE)
