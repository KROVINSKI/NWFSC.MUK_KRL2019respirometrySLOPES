...
### 8.2) Factor Krill ID
```{r 8.2) Krill ID as a factor & Grouping by Krill ID}
...
### 8.3) Slope & rsq values
Analysis, Respirometry - Creating Slope Functions & Linear Models  
```{r 8.3) Analysis, Respirometry - Creating Slope Functions & Linear Models  }
#*********************************
## 8.3) Creating the ds dataframe
#*********************************
...
### 8.4) Filtering krillslopes by each Trial
```{r 8.4 Filtering dtotal by each trial}
...
### 8.5) Filtering dtotal by each Trial and finding the 80% time
```{r 8.5 Filtering dtotal by each trial and finding the 80% DO times, warnings= FALSE}
