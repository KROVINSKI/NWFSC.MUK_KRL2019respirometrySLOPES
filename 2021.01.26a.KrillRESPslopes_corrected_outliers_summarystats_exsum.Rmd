...
Fixed Effects
All Change and Current
All Change and High Temperature
...
AllChg_lmer1hr_mixed = lmer(CorrSlope ~ Treatment + (1 | MOATS), data = ksSlopes.1hr)
summary(AllChg_lmer1hr_mixed)

CUR_lmer1hr_mixed = fct_relevel(AllChg_lmer1hr_mixed$treatment, "Current")

fct_relevel(lmer1hr_mixed, "Treatment", after = 2)

# CurxChgxTMPlmer.ksSlopes.1hr <-  fct_relevel(lmer.ksSlopes.1hr$treatment, "Current")
# # reads current first 
...
# COXph portional hazard
# COXme for mixed efffects
